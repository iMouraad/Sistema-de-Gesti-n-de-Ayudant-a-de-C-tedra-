...
public class CoordinadorController {
    ...
    @GetMapping
    public String homeCoordinador(Model model, Principal principal) {
        if (principal != null) {
            usuario_sistema usuario = usuarioRepository.findByUsername(principal.getName()).orElse(null);
            if (usuario != null) {
                ...
                model.addAttribute("username", "Coordinador");
                model.addAttribute("userInitial", "C");
            }
        }
